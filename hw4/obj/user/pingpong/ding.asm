...
40000024:	68 14 0e 00 40       	push   $0x40000e14
...
4000004e:	68 20 0e 00 40       	push   $0x40000e20
...
40000078:	68 2c 0e 00 40       	push   $0x40000e2c
...
40000226:	e8 75 09 00 00       	call   40000ba0 <__udivdi3>
...
4000025f:	e8 6c 0a 00 00       	call   40000cd0 <__umoddi3>
40000264:	83 c4 08             	add    $0x8,%esp
40000267:	57                   	push   %edi
40000268:	0f be 80 38 0e 00 40 	movsbl 0x40000e38(%eax),%eax
...
40000377:	ff 24 95 50 0e 00 40 	jmp    *0x40000e50(,%edx,4)
...
40000471:	eb 62                	jmp    400004d5 <vprintfmt+0x1d4>
		...
		case 's':
			if ((p = va_arg(ap, char *)) == NULL)
				p = "(null)";
40000473:	bb 49 0e 00 40       	mov    $0x40000e49,%ebx
...
40000b29:	83 ec 10             	sub    $0x10,%esp
    printf("ding started.\n");
40000b2c:	68 a8 0f 00 40       	push   $0x40000fa8
...
40000b36:	83 c4 0c             	add    $0xc,%esp
40000b39:	ff 35 00 00 00 e0    	pushl  0xe0000000
40000b3f:	68 00 00 00 e0       	push   $0xe0000000
40000b44:	68 b8 0f 00 40       	push   $0x40000fb8
40000b49:	e8 67 f6 ff ff       	call   400001b5 <printf>
    printf("ding: writing the value %d to the address %x\n", val, addr);
40000b4e:	83 c4 0c             	add    $0xc,%esp
40000b51:	68 00 00 00 e0       	push   $0xe0000000
40000b56:	68 2c 01 00 00       	push   $0x12c
40000b5b:	68 dc 0f 00 40       	push   $0x40000fdc
40000b60:	e8 50 f6 ff ff       	call   400001b5 <printf>
    *addr = val;
40000b65:	c7 05 00 00 00 e0 2c 	movl   $0x12c,0xe0000000
40000b6c:	01 00 00 
    yield();
40000b6f:	e8 cb fb ff ff       	call   4000073f <yield>
    printf("ding: the new value at address %x: %d\n", addr, *addr);
40000b74:	83 c4 0c             	add    $0xc,%esp
40000b77:	ff 35 00 00 00 e0    	pushl  0xe0000000
40000b7d:	68 00 00 00 e0       	push   $0xe0000000
40000b82:	68 0c 10 00 40       	push   $0x4000100c
40000b87:	e8 29 f6 ff ff       	call   400001b5 <printf>
40000b8c:	83 c4 10             	add    $0x10,%esp

    return 0;
}
40000b8f:	b8 00 00 00 00       	mov    $0x0,%eax
40000b94:	8b 4d fc             	mov    -0x4(%ebp),%ecx
40000b97:	c9                   	leave  
40000b98:	8d 61 fc             	lea    -0x4(%ecx),%esp
40000b9b:	c3                   	ret    
40000b9c:	66 90                	xchg   %ax,%ax
40000b9e:	66 90                	xchg   %ax,%ax

40000ba0 <__udivdi3>:
40000ba0:	55                   	push   %ebp
40000ba1:	57                   	push   %edi
40000ba2:	56                   	push   %esi
40000ba3:	53                   	push   %ebx
40000ba4:	83 ec 1c             	sub    $0x1c,%esp
40000ba7:	8b 74 24 3c          	mov    0x3c(%esp),%esi
40000bab:	8b 5c 24 30          	mov    0x30(%esp),%ebx
40000baf:	8b 4c 24 34          	mov    0x34(%esp),%ecx
40000bb3:	8b 7c 24 38          	mov    0x38(%esp),%edi
40000bb7:	85 f6                	test   %esi,%esi
40000bb9:	89 5c 24 08          	mov    %ebx,0x8(%esp)
40000bbd:	89 ca                	mov    %ecx,%edx
40000bbf:	89 f8                	mov    %edi,%eax
40000bc1:	75 3d                	jne    40000c00 <__udivdi3+0x60>
40000bc3:	39 cf                	cmp    %ecx,%edi
40000bc5:	0f 87 c5 00 00 00    	ja     40000c90 <__udivdi3+0xf0>
40000bcb:	85 ff                	test   %edi,%edi
40000bcd:	89 fd                	mov    %edi,%ebp
40000bcf:	75 0b                	jne    40000bdc <__udivdi3+0x3c>
40000bd1:	b8 01 00 00 00       	mov    $0x1,%eax
40000bd6:	31 d2                	xor    %edx,%edx
40000bd8:	f7 f7                	div    %edi
40000bda:	89 c5                	mov    %eax,%ebp
40000bdc:	89 c8                	mov    %ecx,%eax
40000bde:	31 d2                	xor    %edx,%edx
40000be0:	f7 f5                	div    %ebp
40000be2:	89 c1                	mov    %eax,%ecx
40000be4:	89 d8                	mov    %ebx,%eax
40000be6:	89 cf                	mov    %ecx,%edi
40000be8:	f7 f5                	div    %ebp
40000bea:	89 c3                	mov    %eax,%ebx
40000bec:	89 d8                	mov    %ebx,%eax
40000bee:	89 fa                	mov    %edi,%edx
40000bf0:	83 c4 1c             	add    $0x1c,%esp
40000bf3:	5b                   	pop    %ebx
40000bf4:	5e                   	pop    %esi
40000bf5:	5f                   	pop    %edi
40000bf6:	5d                   	pop    %ebp
...
40000c00:	39 ce                	cmp    %ecx,%esi
40000c02:	77 74                	ja     40000c78 <__udivdi3+0xd8>
40000c04:	0f bd fe             	bsr    %esi,%edi
40000c07:	83 f7 1f             	xor    $0x1f,%edi
40000c0a:	0f 84 98 00 00 00    	je     40000ca8 <__udivdi3+0x108>
40000c10:	bb 20 00 00 00       	mov    $0x20,%ebx
40000c15:	89 f9                	mov    %edi,%ecx
40000c17:	89 c5                	mov    %eax,%ebp
40000c19:	29 fb                	sub    %edi,%ebx
40000c1b:	d3 e6                	shl    %cl,%esi
40000c1d:	89 d9                	mov    %ebx,%ecx
40000c1f:	d3 ed                	shr    %cl,%ebp
40000c21:	89 f9                	mov    %edi,%ecx
40000c23:	d3 e0                	shl    %cl,%eax
40000c25:	09 ee                	or     %ebp,%esi
40000c27:	89 d9                	mov    %ebx,%ecx
40000c29:	89 44 24 0c          	mov    %eax,0xc(%esp)
40000c2d:	89 d5                	mov    %edx,%ebp
40000c2f:	8b 44 24 08          	mov    0x8(%esp),%eax
40000c33:	d3 ed                	shr    %cl,%ebp
40000c35:	89 f9                	mov    %edi,%ecx
40000c37:	d3 e2                	shl    %cl,%edx
40000c39:	89 d9                	mov    %ebx,%ecx
40000c3b:	d3 e8                	shr    %cl,%eax
40000c3d:	09 c2                	or     %eax,%edx
40000c3f:	89 d0                	mov    %edx,%eax
40000c41:	89 ea                	mov    %ebp,%edx
40000c43:	f7 f6                	div    %esi
40000c45:	89 d5                	mov    %edx,%ebp
40000c47:	89 c3                	mov    %eax,%ebx
40000c49:	f7 64 24 0c          	mull   0xc(%esp)
40000c4d:	39 d5                	cmp    %edx,%ebp
40000c4f:	72 10                	jb     40000c61 <__udivdi3+0xc1>
40000c51:	8b 74 24 08          	mov    0x8(%esp),%esi
40000c55:	89 f9                	mov    %edi,%ecx
40000c57:	d3 e6                	shl    %cl,%esi
40000c59:	39 c6                	cmp    %eax,%esi
40000c5b:	73 07                	jae    40000c64 <__udivdi3+0xc4>
40000c5d:	39 d5                	cmp    %edx,%ebp
40000c5f:	75 03                	jne    40000c64 <__udivdi3+0xc4>
40000c61:	83 eb 01             	sub    $0x1,%ebx
40000c64:	31 ff                	xor    %edi,%edi
40000c66:	89 d8                	mov    %ebx,%eax
40000c68:	89 fa                	mov    %edi,%edx
40000c6a:	83 c4 1c             	add    $0x1c,%esp
40000c6d:	5b                   	pop    %ebx
40000c6e:	5e                   	pop    %esi
40000c6f:	5f                   	pop    %edi
40000c70:	5d                   	pop    %ebp
...
40000c78:	31 ff                	xor    %edi,%edi
40000c7a:	31 db                	xor    %ebx,%ebx
40000c7c:	89 d8                	mov    %ebx,%eax
40000c7e:	89 fa                	mov    %edi,%edx
40000c80:	83 c4 1c             	add    $0x1c,%esp
40000c83:	5b                   	pop    %ebx
40000c84:	5e                   	pop    %esi
40000c85:	5f                   	pop    %edi
40000c86:	5d                   	pop    %ebp
...
40000c90:	89 d8                	mov    %ebx,%eax
40000c92:	f7 f7                	div    %edi
40000c94:	31 ff                	xor    %edi,%edi
40000c96:	89 c3                	mov    %eax,%ebx
40000c98:	89 d8                	mov    %ebx,%eax
40000c9a:	89 fa                	mov    %edi,%edx
40000c9c:	83 c4 1c             	add    $0x1c,%esp
40000c9f:	5b                   	pop    %ebx
40000ca0:	5e                   	pop    %esi
40000ca1:	5f                   	pop    %edi
40000ca2:	5d                   	pop    %ebp
40000ca3:	c3                   	ret    
40000ca4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
40000ca8:	39 ce                	cmp    %ecx,%esi
40000caa:	72 0c                	jb     40000cb8 <__udivdi3+0x118>
40000cac:	31 db                	xor    %ebx,%ebx
40000cae:	3b 44 24 08          	cmp    0x8(%esp),%eax
40000cb2:	0f 87 34 ff ff ff    	ja     40000bec <__udivdi3+0x4c>
40000cb8:	bb 01 00 00 00       	mov    $0x1,%ebx
40000cbd:	e9 2a ff ff ff       	jmp    40000bec <__udivdi3+0x4c>
40000cc2:	66 90                	xchg   %ax,%ax
40000cc4:	66 90                	xchg   %ax,%ax
40000cc6:	66 90                	xchg   %ax,%ax
40000cc8:	66 90                	xchg   %ax,%ax
40000cca:	66 90                	xchg   %ax,%ax
40000ccc:	66 90                	xchg   %ax,%ax
40000cce:	66 90                	xchg   %ax,%ax

40000cd0 <__umoddi3>:
40000cd0:	55                   	push   %ebp
40000cd1:	57                   	push   %edi
40000cd2:	56                   	push   %esi
40000cd3:	53                   	push   %ebx
40000cd4:	83 ec 1c             	sub    $0x1c,%esp
40000cd7:	8b 44 24 3c          	mov    0x3c(%esp),%eax
40000cdb:	8b 4c 24 30          	mov    0x30(%esp),%ecx
40000cdf:	8b 74 24 34          	mov    0x34(%esp),%esi
40000ce3:	8b 7c 24 38          	mov    0x38(%esp),%edi
40000ce7:	85 c0                	test   %eax,%eax
40000ce9:	89 44 24 0c          	mov    %eax,0xc(%esp)
40000ced:	89 4c 24 08          	mov    %ecx,0x8(%esp)
40000cf1:	89 3c 24             	mov    %edi,(%esp)
40000cf4:	89 4c 24 04          	mov    %ecx,0x4(%esp)
40000cf8:	89 f2                	mov    %esi,%edx
40000cfa:	75 14                	jne    40000d10 <__umoddi3+0x40>
40000cfc:	39 f7                	cmp    %esi,%edi
40000cfe:	76 40                	jbe    40000d40 <__umoddi3+0x70>
40000d00:	89 c8                	mov    %ecx,%eax
40000d02:	f7 f7                	div    %edi
40000d04:	89 d0                	mov    %edx,%eax
40000d06:	31 d2                	xor    %edx,%edx
40000d08:	83 c4 1c             	add    $0x1c,%esp
40000d0b:	5b                   	pop    %ebx
40000d0c:	5e                   	pop    %esi
40000d0d:	5f                   	pop    %edi
40000d0e:	5d                   	pop    %ebp
40000d0f:	c3                   	ret    
40000d10:	39 f0                	cmp    %esi,%eax
40000d12:	89 f3                	mov    %esi,%ebx
40000d14:	77 4a                	ja     40000d60 <__umoddi3+0x90>
40000d16:	0f bd e8             	bsr    %eax,%ebp
40000d19:	83 f5 1f             	xor    $0x1f,%ebp
40000d1c:	75 52                	jne    40000d70 <__umoddi3+0xa0>
40000d1e:	39 f0                	cmp    %esi,%eax
40000d20:	0f 82 da 00 00 00    	jb     40000e00 <__umoddi3+0x130>
40000d26:	39 0c 24             	cmp    %ecx,(%esp)
40000d29:	0f 86 d1 00 00 00    	jbe    40000e00 <__umoddi3+0x130>
40000d2f:	8b 44 24 04          	mov    0x4(%esp),%eax
40000d33:	83 c4 1c             	add    $0x1c,%esp
40000d36:	5b                   	pop    %ebx
40000d37:	5e                   	pop    %esi
40000d38:	5f                   	pop    %edi
40000d39:	5d                   	pop    %ebp
...
40000d40:	85 ff                	test   %edi,%edi
40000d42:	89 fd                	mov    %edi,%ebp
40000d44:	75 0b                	jne    40000d51 <__umoddi3+0x81>
40000d46:	b8 01 00 00 00       	mov    $0x1,%eax
40000d4b:	31 d2                	xor    %edx,%edx
40000d4d:	f7 f7                	div    %edi
40000d4f:	89 c5                	mov    %eax,%ebp
40000d51:	89 f0                	mov    %esi,%eax
40000d53:	31 d2                	xor    %edx,%edx
40000d55:	f7 f5                	div    %ebp
40000d57:	89 c8                	mov    %ecx,%eax
40000d59:	f7 f5                	div    %ebp
40000d5b:	eb a7                	jmp    40000d04 <__umoddi3+0x34>
40000d5d:	8d 76 00             	lea    0x0(%esi),%esi
40000d60:	89 c8                	mov    %ecx,%eax
40000d62:	89 f2                	mov    %esi,%edx
40000d64:	83 c4 1c             	add    $0x1c,%esp
40000d67:	5b                   	pop    %ebx
40000d68:	5e                   	pop    %esi
40000d69:	5f                   	pop    %edi
40000d6a:	5d                   	pop    %ebp
40000d6b:	c3                   	ret    
40000d6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
40000d70:	8b 34 24             	mov    (%esp),%esi
40000d73:	bf 20 00 00 00       	mov    $0x20,%edi
40000d78:	89 e9                	mov    %ebp,%ecx
40000d7a:	29 ef                	sub    %ebp,%edi
40000d7c:	d3 e0                	shl    %cl,%eax
40000d7e:	89 f9                	mov    %edi,%ecx
40000d80:	89 f2                	mov    %esi,%edx
40000d82:	d3 ea                	shr    %cl,%edx
40000d84:	89 e9                	mov    %ebp,%ecx
40000d86:	09 c2                	or     %eax,%edx
40000d88:	89 d8                	mov    %ebx,%eax
40000d8a:	89 14 24             	mov    %edx,(%esp)
40000d8d:	89 f2                	mov    %esi,%edx
40000d8f:	d3 e2                	shl    %cl,%edx
40000d91:	89 f9                	mov    %edi,%ecx
40000d93:	89 54 24 04          	mov    %edx,0x4(%esp)
40000d97:	8b 54 24 08          	mov    0x8(%esp),%edx
40000d9b:	d3 e8                	shr    %cl,%eax
40000d9d:	89 e9                	mov    %ebp,%ecx
40000d9f:	89 c6                	mov    %eax,%esi
40000da1:	d3 e3                	shl    %cl,%ebx
40000da3:	89 f9                	mov    %edi,%ecx
40000da5:	89 d0                	mov    %edx,%eax
40000da7:	d3 e8                	shr    %cl,%eax
40000da9:	89 e9                	mov    %ebp,%ecx
40000dab:	09 d8                	or     %ebx,%eax
40000dad:	89 d3                	mov    %edx,%ebx
40000daf:	89 f2                	mov    %esi,%edx
40000db1:	f7 34 24             	divl   (%esp)
40000db4:	89 d6                	mov    %edx,%esi
40000db6:	d3 e3                	shl    %cl,%ebx
40000db8:	f7 64 24 04          	mull   0x4(%esp)
40000dbc:	39 d6                	cmp    %edx,%esi
40000dbe:	89 5c 24 08          	mov    %ebx,0x8(%esp)
40000dc2:	89 d1                	mov    %edx,%ecx
40000dc4:	89 c3                	mov    %eax,%ebx
40000dc6:	72 08                	jb     40000dd0 <__umoddi3+0x100>
40000dc8:	75 11                	jne    40000ddb <__umoddi3+0x10b>
40000dca:	39 44 24 08          	cmp    %eax,0x8(%esp)
40000dce:	73 0b                	jae    40000ddb <__umoddi3+0x10b>
40000dd0:	2b 44 24 04          	sub    0x4(%esp),%eax
40000dd4:	1b 14 24             	sbb    (%esp),%edx
40000dd7:	89 d1                	mov    %edx,%ecx
40000dd9:	89 c3                	mov    %eax,%ebx
40000ddb:	8b 54 24 08          	mov    0x8(%esp),%edx
40000ddf:	29 da                	sub    %ebx,%edx
40000de1:	19 ce                	sbb    %ecx,%esi
40000de3:	89 f9                	mov    %edi,%ecx
40000de5:	89 f0                	mov    %esi,%eax
40000de7:	d3 e0                	shl    %cl,%eax
40000de9:	89 e9                	mov    %ebp,%ecx
40000deb:	d3 ea                	shr    %cl,%edx
40000ded:	89 e9                	mov    %ebp,%ecx
40000def:	d3 ee                	shr    %cl,%esi
40000df1:	09 d0                	or     %edx,%eax
40000df3:	89 f2                	mov    %esi,%edx
40000df5:	83 c4 1c             	add    $0x1c,%esp
40000df8:	5b                   	pop    %ebx
40000df9:	5e                   	pop    %esi
40000dfa:	5f                   	pop    %edi
40000dfb:	5d                   	pop    %ebp
...
40000e00:	89 f2                	mov    %esi,%edx
40000e02:	29 f9                	sub    %edi,%ecx
40000e04:	1b 54 24 0c          	sbb    0xc(%esp),%edx
40000e08:	89 4c 24 04          	mov    %ecx,0x4(%esp)
40000e0c:	e9 1e ff ff ff       	jmp    40000d2f <__umoddi3+0x5f>

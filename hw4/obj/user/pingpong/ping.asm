...
40000b56:	6a 64                	push   $0x64
40000b58:	68 dc 0f 00 40       	push   $0x40000fdc
40000b5d:	e8 53 f6 ff ff       	call   400001b5 <printf>
    *addr = val;
40000b62:	c7 05 00 00 00 e0 64 	movl   $0x64,0xe0000000
40000b69:	00 00 00 
    yield();
40000b6c:	e8 ce fb ff ff       	call   4000073f <yield>
    printf("ping: the new value at address %x: %d\n", addr, *addr);
40000b71:	83 c4 0c             	add    $0xc,%esp
40000b74:	ff 35 00 00 00 e0    	pushl  0xe0000000
40000b7a:	68 00 00 00 e0       	push   $0xe0000000
40000b7f:	68 0c 10 00 40       	push   $0x4000100c
40000b84:	e8 2c f6 ff ff       	call   400001b5 <printf>
40000b89:	83 c4 10             	add    $0x10,%esp

    return 0;
}
40000b8c:	b8 00 00 00 00       	mov    $0x0,%eax
40000b91:	8b 4d fc             	mov    -0x4(%ebp),%ecx
40000b94:	c9                   	leave  
40000b95:	8d 61 fc             	lea    -0x4(%ecx),%esp
40000b98:	c3                   	ret    

...
40000024:	68 54 0e 00 40       	push   $0x40000e54
...
4000004e:	68 60 0e 00 40       	push   $0x40000e60
...
40000078:	68 6c 0e 00 40       	push   $0x40000e6c
...
40000226:	e8 b5 09 00 00       	call   40000be0 <__udivdi3>
...
4000025f:	e8 ac 0a 00 00       	call   40000d10 <__umoddi3>
40000264:	83 c4 08             	add    $0x8,%esp
40000267:	57                   	push   %edi
40000268:	0f be 80 78 0e 00 40 	movsbl 0x40000e78(%eax),%eax
...
40000377:	ff 24 95 90 0e 00 40 	jmp    *0x40000e90(,%edx,4)
...
40000471:	eb 62                	jmp    400004d5 <vprintfmt+0x1d4>
		...
		case 's':
			if ((p = va_arg(ap, char *)) == NULL)
				p = "(null)";
40000473:	bb 89 0e 00 40       	mov    $0x40000e89,%ebx
...
40000b28:	53                   	push   %ebx
40000b29:	51                   	push   %ecx
sys_fork(void)
{
	int errno;
	pid_t pid;
	...
	asm volatile("int %2" 
40000b2a:	b8 03 00 00 00       	mov    $0x3,%eax
40000b2f:	cd 30                	int    $0x30
    pid_t pid;

    pid = sys_fork();
    printf("out after sys_fork \d \n",pid);
40000b31:	83 ec 08             	sub    $0x8,%esp
40000b34:	53                   	push   %ebx
40000b35:	68 e8 0f 00 40       	push   $0x40000fe8
40000b3a:	e8 76 f6 ff ff       	call   400001b5 <printf>
    if (pid == 0){
40000b3f:	83 c4 10             	add    $0x10,%esp
40000b42:	85 db                	test   %ebx,%ebx
40000b44:	75 4d                	jne    40000b93 <main+0x78>
40000b46:	b8 03 00 00 00       	mov    $0x3,%eax
40000b4b:	cd 30                	int    $0x30
        pid = sys_fork();
	printf("out after sys_fork \d \n",pid);
40000b4d:	83 ec 08             	sub    $0x8,%esp
40000b50:	53                   	push   %ebx
40000b51:	68 e8 0f 00 40       	push   $0x40000fe8
40000b56:	e8 5a f6 ff ff       	call   400001b5 <printf>
        if(pid == 0){
40000b5b:	83 c4 10             	add    $0x10,%esp
40000b5e:	85 db                	test   %ebx,%ebx
40000b60:	75 18                	jne    40000b7a <main+0x5f>
            printf("This is grandchild, global = %p\n", global_test);
40000b62:	83 ec 08             	sub    $0x8,%esp
40000b65:	ff 35 00 30 00 40    	pushl  0x40003000
40000b6b:	68 54 10 00 40       	push   $0x40001054
40000b70:	e8 40 f6 ff ff       	call   400001b5 <printf>
40000b75:	83 c4 10             	add    $0x10,%esp
40000b78:	eb 4c                	jmp    40000bc6 <main+0xab>
        }else{
            printf("Child forks %d, global = %p\n", pid, global_test);
40000b7a:	83 ec 04             	sub    $0x4,%esp
40000b7d:	ff 35 00 30 00 40    	pushl  0x40003000
40000b83:	53                   	push   %ebx
40000b84:	68 ff 0f 00 40       	push   $0x40000fff
40000b89:	e8 27 f6 ff ff       	call   400001b5 <printf>
40000b8e:	83 c4 10             	add    $0x10,%esp
40000b91:	eb 33                	jmp    40000bc6 <main+0xab>
        }
    }else{
        printf("parent forks %d, global = %p\n", pid, global_test);
40000b93:	83 ec 04             	sub    $0x4,%esp
40000b96:	ff 35 00 30 00 40    	pushl  0x40003000
40000b9c:	53                   	push   %ebx
40000b9d:	68 1c 10 00 40       	push   $0x4000101c
40000ba2:	e8 0e f6 ff ff       	call   400001b5 <printf>
        global_test = 0x5678;
40000ba7:	c7 05 00 30 00 40 78 	movl   $0x5678,0x40003000
40000bae:	56 00 00 
        printf("parent global_test1 = %p\n", global_test);
40000bb1:	83 c4 08             	add    $0x8,%esp
40000bb4:	68 78 56 00 00       	push   $0x5678
40000bb9:	68 3a 10 00 40       	push   $0x4000103a
40000bbe:	e8 f2 f5 ff ff       	call   400001b5 <printf>
40000bc3:	83 c4 10             	add    $0x10,%esp
    }

    return 0;
}
40000bc6:	b8 00 00 00 00       	mov    $0x0,%eax
40000bcb:	8d 65 f8             	lea    -0x8(%ebp),%esp
40000bce:	59                   	pop    %ecx
40000bcf:	5b                   	pop    %ebx
40000bd0:	5d                   	pop    %ebp
40000bd1:	8d 61 fc             	lea    -0x4(%ecx),%esp
40000bd4:	c3                   	ret    
40000bd5:	66 90                	xchg   %ax,%ax
40000bd7:	66 90                	xchg   %ax,%ax
40000bd9:	66 90                	xchg   %ax,%ax
40000bdb:	66 90                	xchg   %ax,%ax
40000bdd:	66 90                	xchg   %ax,%ax
40000bdf:	90                   	nop

40000be0 <__udivdi3>:
40000be0:	55                   	push   %ebp
40000be1:	57                   	push   %edi
40000be2:	56                   	push   %esi
40000be3:	53                   	push   %ebx
40000be4:	83 ec 1c             	sub    $0x1c,%esp
40000be7:	8b 74 24 3c          	mov    0x3c(%esp),%esi
40000beb:	8b 5c 24 30          	mov    0x30(%esp),%ebx
40000bef:	8b 4c 24 34          	mov    0x34(%esp),%ecx
40000bf3:	8b 7c 24 38          	mov    0x38(%esp),%edi
40000bf7:	85 f6                	test   %esi,%esi
40000bf9:	89 5c 24 08          	mov    %ebx,0x8(%esp)
40000bfd:	89 ca                	mov    %ecx,%edx
40000bff:	89 f8                	mov    %edi,%eax
40000c01:	75 3d                	jne    40000c40 <__udivdi3+0x60>
40000c03:	39 cf                	cmp    %ecx,%edi
40000c05:	0f 87 c5 00 00 00    	ja     40000cd0 <__udivdi3+0xf0>
40000c0b:	85 ff                	test   %edi,%edi
40000c0d:	89 fd                	mov    %edi,%ebp
40000c0f:	75 0b                	jne    40000c1c <__udivdi3+0x3c>
40000c11:	b8 01 00 00 00       	mov    $0x1,%eax
40000c16:	31 d2                	xor    %edx,%edx
40000c18:	f7 f7                	div    %edi
40000c1a:	89 c5                	mov    %eax,%ebp
40000c1c:	89 c8                	mov    %ecx,%eax
40000c1e:	31 d2                	xor    %edx,%edx
40000c20:	f7 f5                	div    %ebp
40000c22:	89 c1                	mov    %eax,%ecx
40000c24:	89 d8                	mov    %ebx,%eax
40000c26:	89 cf                	mov    %ecx,%edi
40000c28:	f7 f5                	div    %ebp
40000c2a:	89 c3                	mov    %eax,%ebx
40000c2c:	89 d8                	mov    %ebx,%eax
40000c2e:	89 fa                	mov    %edi,%edx
40000c30:	83 c4 1c             	add    $0x1c,%esp
40000c33:	5b                   	pop    %ebx
40000c34:	5e                   	pop    %esi
40000c35:	5f                   	pop    %edi
40000c36:	5d                   	pop    %ebp
...
40000c40:	39 ce                	cmp    %ecx,%esi
40000c42:	77 74                	ja     40000cb8 <__udivdi3+0xd8>
40000c44:	0f bd fe             	bsr    %esi,%edi
40000c47:	83 f7 1f             	xor    $0x1f,%edi
40000c4a:	0f 84 98 00 00 00    	je     40000ce8 <__udivdi3+0x108>
40000c50:	bb 20 00 00 00       	mov    $0x20,%ebx
40000c55:	89 f9                	mov    %edi,%ecx
40000c57:	89 c5                	mov    %eax,%ebp
40000c59:	29 fb                	sub    %edi,%ebx
40000c5b:	d3 e6                	shl    %cl,%esi
40000c5d:	89 d9                	mov    %ebx,%ecx
40000c5f:	d3 ed                	shr    %cl,%ebp
40000c61:	89 f9                	mov    %edi,%ecx
40000c63:	d3 e0                	shl    %cl,%eax
40000c65:	09 ee                	or     %ebp,%esi
40000c67:	89 d9                	mov    %ebx,%ecx
40000c69:	89 44 24 0c          	mov    %eax,0xc(%esp)
40000c6d:	89 d5                	mov    %edx,%ebp
40000c6f:	8b 44 24 08          	mov    0x8(%esp),%eax
40000c73:	d3 ed                	shr    %cl,%ebp
40000c75:	89 f9                	mov    %edi,%ecx
40000c77:	d3 e2                	shl    %cl,%edx
40000c79:	89 d9                	mov    %ebx,%ecx
40000c7b:	d3 e8                	shr    %cl,%eax
40000c7d:	09 c2                	or     %eax,%edx
40000c7f:	89 d0                	mov    %edx,%eax
40000c81:	89 ea                	mov    %ebp,%edx
40000c83:	f7 f6                	div    %esi
40000c85:	89 d5                	mov    %edx,%ebp
40000c87:	89 c3                	mov    %eax,%ebx
40000c89:	f7 64 24 0c          	mull   0xc(%esp)
40000c8d:	39 d5                	cmp    %edx,%ebp
40000c8f:	72 10                	jb     40000ca1 <__udivdi3+0xc1>
40000c91:	8b 74 24 08          	mov    0x8(%esp),%esi
40000c95:	89 f9                	mov    %edi,%ecx
40000c97:	d3 e6                	shl    %cl,%esi
40000c99:	39 c6                	cmp    %eax,%esi
40000c9b:	73 07                	jae    40000ca4 <__udivdi3+0xc4>
40000c9d:	39 d5                	cmp    %edx,%ebp
40000c9f:	75 03                	jne    40000ca4 <__udivdi3+0xc4>
40000ca1:	83 eb 01             	sub    $0x1,%ebx
40000ca4:	31 ff                	xor    %edi,%edi
40000ca6:	89 d8                	mov    %ebx,%eax
40000ca8:	89 fa                	mov    %edi,%edx
40000caa:	83 c4 1c             	add    $0x1c,%esp
40000cad:	5b                   	pop    %ebx
40000cae:	5e                   	pop    %esi
40000caf:	5f                   	pop    %edi
40000cb0:	5d                   	pop    %ebp
...
40000cb8:	31 ff                	xor    %edi,%edi
40000cba:	31 db                	xor    %ebx,%ebx
40000cbc:	89 d8                	mov    %ebx,%eax
40000cbe:	89 fa                	mov    %edi,%edx
40000cc0:	83 c4 1c             	add    $0x1c,%esp
40000cc3:	5b                   	pop    %ebx
40000cc4:	5e                   	pop    %esi
40000cc5:	5f                   	pop    %edi
40000cc6:	5d                   	pop    %ebp
...
40000cd0:	89 d8                	mov    %ebx,%eax
40000cd2:	f7 f7                	div    %edi
40000cd4:	31 ff                	xor    %edi,%edi
40000cd6:	89 c3                	mov    %eax,%ebx
40000cd8:	89 d8                	mov    %ebx,%eax
40000cda:	89 fa                	mov    %edi,%edx
40000cdc:	83 c4 1c             	add    $0x1c,%esp
40000cdf:	5b                   	pop    %ebx
40000ce0:	5e                   	pop    %esi
40000ce1:	5f                   	pop    %edi
40000ce2:	5d                   	pop    %ebp
40000ce3:	c3                   	ret    
40000ce4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
40000ce8:	39 ce                	cmp    %ecx,%esi
40000cea:	72 0c                	jb     40000cf8 <__udivdi3+0x118>
40000cec:	31 db                	xor    %ebx,%ebx
40000cee:	3b 44 24 08          	cmp    0x8(%esp),%eax
40000cf2:	0f 87 34 ff ff ff    	ja     40000c2c <__udivdi3+0x4c>
40000cf8:	bb 01 00 00 00       	mov    $0x1,%ebx
40000cfd:	e9 2a ff ff ff       	jmp    40000c2c <__udivdi3+0x4c>
40000d02:	66 90                	xchg   %ax,%ax
40000d04:	66 90                	xchg   %ax,%ax
40000d06:	66 90                	xchg   %ax,%ax
40000d08:	66 90                	xchg   %ax,%ax
40000d0a:	66 90                	xchg   %ax,%ax
40000d0c:	66 90                	xchg   %ax,%ax
...
40000d14:	83 ec 1c             	sub    $0x1c,%esp
40000d17:	8b 44 24 3c          	mov    0x3c(%esp),%eax
40000d1b:	8b 4c 24 30          	mov    0x30(%esp),%ecx
40000d1f:	8b 74 24 34          	mov    0x34(%esp),%esi
40000d23:	8b 7c 24 38          	mov    0x38(%esp),%edi
40000d27:	85 c0                	test   %eax,%eax
40000d29:	89 44 24 0c          	mov    %eax,0xc(%esp)
40000d2d:	89 4c 24 08          	mov    %ecx,0x8(%esp)
40000d31:	89 3c 24             	mov    %edi,(%esp)
40000d34:	89 4c 24 04          	mov    %ecx,0x4(%esp)
40000d38:	89 f2                	mov    %esi,%edx
40000d3a:	75 14                	jne    40000d50 <__umoddi3+0x40>
40000d3c:	39 f7                	cmp    %esi,%edi
40000d3e:	76 40                	jbe    40000d80 <__umoddi3+0x70>
40000d40:	89 c8                	mov    %ecx,%eax
40000d42:	f7 f7                	div    %edi
40000d44:	89 d0                	mov    %edx,%eax
40000d46:	31 d2                	xor    %edx,%edx
40000d48:	83 c4 1c             	add    $0x1c,%esp
40000d4b:	5b                   	pop    %ebx
40000d4c:	5e                   	pop    %esi
40000d4d:	5f                   	pop    %edi
40000d4e:	5d                   	pop    %ebp
40000d4f:	c3                   	ret    
40000d50:	39 f0                	cmp    %esi,%eax
40000d52:	89 f3                	mov    %esi,%ebx
40000d54:	77 4a                	ja     40000da0 <__umoddi3+0x90>
40000d56:	0f bd e8             	bsr    %eax,%ebp
40000d59:	83 f5 1f             	xor    $0x1f,%ebp
40000d5c:	75 52                	jne    40000db0 <__umoddi3+0xa0>
40000d5e:	39 f0                	cmp    %esi,%eax
40000d60:	0f 82 da 00 00 00    	jb     40000e40 <__umoddi3+0x130>
40000d66:	39 0c 24             	cmp    %ecx,(%esp)
40000d69:	0f 86 d1 00 00 00    	jbe    40000e40 <__umoddi3+0x130>
40000d6f:	8b 44 24 04          	mov    0x4(%esp),%eax
40000d73:	83 c4 1c             	add    $0x1c,%esp
40000d76:	5b                   	pop    %ebx
40000d77:	5e                   	pop    %esi
40000d78:	5f                   	pop    %edi
40000d79:	5d                   	pop    %ebp
...
40000d80:	85 ff                	test   %edi,%edi
40000d82:	89 fd                	mov    %edi,%ebp
40000d84:	75 0b                	jne    40000d91 <__umoddi3+0x81>
40000d86:	b8 01 00 00 00       	mov    $0x1,%eax
40000d8b:	31 d2                	xor    %edx,%edx
40000d8d:	f7 f7                	div    %edi
40000d8f:	89 c5                	mov    %eax,%ebp
40000d91:	89 f0                	mov    %esi,%eax
40000d93:	31 d2                	xor    %edx,%edx
40000d95:	f7 f5                	div    %ebp
40000d97:	89 c8                	mov    %ecx,%eax
40000d99:	f7 f5                	div    %ebp
40000d9b:	eb a7                	jmp    40000d44 <__umoddi3+0x34>
40000d9d:	8d 76 00             	lea    0x0(%esi),%esi
40000da0:	89 c8                	mov    %ecx,%eax
40000da2:	89 f2                	mov    %esi,%edx
40000da4:	83 c4 1c             	add    $0x1c,%esp
40000da7:	5b                   	pop    %ebx
40000da8:	5e                   	pop    %esi
40000da9:	5f                   	pop    %edi
40000daa:	5d                   	pop    %ebp
...
40000db0:	8b 34 24             	mov    (%esp),%esi
40000db3:	bf 20 00 00 00       	mov    $0x20,%edi
40000db8:	89 e9                	mov    %ebp,%ecx
40000dba:	29 ef                	sub    %ebp,%edi
40000dbc:	d3 e0                	shl    %cl,%eax
40000dbe:	89 f9                	mov    %edi,%ecx
40000dc0:	89 f2                	mov    %esi,%edx
40000dc2:	d3 ea                	shr    %cl,%edx
40000dc4:	89 e9                	mov    %ebp,%ecx
40000dc6:	09 c2                	or     %eax,%edx
40000dc8:	89 d8                	mov    %ebx,%eax
40000dca:	89 14 24             	mov    %edx,(%esp)
40000dcd:	89 f2                	mov    %esi,%edx
40000dcf:	d3 e2                	shl    %cl,%edx
40000dd1:	89 f9                	mov    %edi,%ecx
40000dd3:	89 54 24 04          	mov    %edx,0x4(%esp)
40000dd7:	8b 54 24 08          	mov    0x8(%esp),%edx
40000ddb:	d3 e8                	shr    %cl,%eax
40000ddd:	89 e9                	mov    %ebp,%ecx
40000ddf:	89 c6                	mov    %eax,%esi
40000de1:	d3 e3                	shl    %cl,%ebx
40000de3:	89 f9                	mov    %edi,%ecx
40000de5:	89 d0                	mov    %edx,%eax
40000de7:	d3 e8                	shr    %cl,%eax
40000de9:	89 e9                	mov    %ebp,%ecx
40000deb:	09 d8                	or     %ebx,%eax
40000ded:	89 d3                	mov    %edx,%ebx
40000def:	89 f2                	mov    %esi,%edx
40000df1:	f7 34 24             	divl   (%esp)
40000df4:	89 d6                	mov    %edx,%esi
40000df6:	d3 e3                	shl    %cl,%ebx
40000df8:	f7 64 24 04          	mull   0x4(%esp)
40000dfc:	39 d6                	cmp    %edx,%esi
40000dfe:	89 5c 24 08          	mov    %ebx,0x8(%esp)
40000e02:	89 d1                	mov    %edx,%ecx
40000e04:	89 c3                	mov    %eax,%ebx
40000e06:	72 08                	jb     40000e10 <__umoddi3+0x100>
40000e08:	75 11                	jne    40000e1b <__umoddi3+0x10b>
40000e0a:	39 44 24 08          	cmp    %eax,0x8(%esp)
40000e0e:	73 0b                	jae    40000e1b <__umoddi3+0x10b>
40000e10:	2b 44 24 04          	sub    0x4(%esp),%eax
40000e14:	1b 14 24             	sbb    (%esp),%edx
40000e17:	89 d1                	mov    %edx,%ecx
40000e19:	89 c3                	mov    %eax,%ebx
40000e1b:	8b 54 24 08          	mov    0x8(%esp),%edx
40000e1f:	29 da                	sub    %ebx,%edx
40000e21:	19 ce                	sbb    %ecx,%esi
40000e23:	89 f9                	mov    %edi,%ecx
40000e25:	89 f0                	mov    %esi,%eax
40000e27:	d3 e0                	shl    %cl,%eax
40000e29:	89 e9                	mov    %ebp,%ecx
40000e2b:	d3 ea                	shr    %cl,%edx
40000e2d:	89 e9                	mov    %ebp,%ecx
40000e2f:	d3 ee                	shr    %cl,%esi
40000e31:	09 d0                	or     %edx,%eax
40000e33:	89 f2                	mov    %esi,%edx
40000e35:	83 c4 1c             	add    $0x1c,%esp
40000e38:	5b                   	pop    %ebx
40000e39:	5e                   	pop    %esi
40000e3a:	5f                   	pop    %edi
40000e3b:	5d                   	pop    %ebp
...
40000e40:	89 f2                	mov    %esi,%edx
40000e42:	29 f9                	sub    %edi,%ecx
40000e44:	1b 54 24 0c          	sbb    0xc(%esp),%edx
40000e48:	89 4c 24 04          	mov    %ecx,0x4(%esp)
40000e4c:	e9 1e ff ff ff       	jmp    40000d6f <__umoddi3+0x5f>
